...
public class TuesdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("cse6a").child("timetable").child("tue");
        recyclerView=(RecyclerView)v.findViewById(R.id.TueRecyclerview);
        avLoadingIndicatorView=(AVLoadingIndicatorView)v.findViewById(R.id.TueAVI);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Timetable,TuesdayFragment.TimetableHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Timetable,TuesdayFragment.TimetableHolder>(
                Timetable.class,
                R.layout.timetable_row,
                TuesdayFragment.TimetableHolder.class,
                databaseReference
        ){
            @Override
            protected void populateViewHolder(TuesdayFragment.TimetableHolder viewHolder, Timetable model, int position) {
